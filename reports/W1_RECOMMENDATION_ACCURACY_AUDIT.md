...
生成时间：2026-06-15T12:28:25.907724+00:00
...
- secondary_score_accuracy：12.5%
- primary_or_secondary_accuracy：12.5%
- score_pool_coverage：50.0%
- mean_actual_score_probability：0.0575
- mean_rps_1x2：0.4131
- mean_exact_score_log_loss：3.4229

样本量提示：当前 n=8。若 n 仍小于 30，本报告只能作为赛后验证快照，不能据此调整模型、阈值或权重。
...
| 1489374 | 德国 vs 库拉索 | 7-1 | 主胜 | 主胜 | 是 | 3-0 | 1-1 | 否 | 0.0144 | 0.0082 | 4.2371 | api-football fixtures/lineups | 是 | partial |
| 1489376 | 荷兰 vs 日本 | 2-2 | 主胜 | 平局 | 否 | 1-1 | 1-1 | 是 | 0.0452 | 0.2862 | 3.0974 | api-football fixtures/lineups | 是 | partial |
| 1489375 | 科特迪瓦 vs 厄瓜多尔 | 1-0 | 客胜 | 主胜 | 否 | 0-0 | 0-0 | 是 | 0.1198 | 0.7001 | 2.1217 | api-football fixtures/lineups | 是 | partial |
| 1539002 | 瑞典 vs 突尼斯 | 5-1 | 主胜 | 主胜 | 是 | 1-0 | 1-1 | 否 | 0.0036 | 0.3054 | 5.6316 | api-football fixtures/lineups | 是 | partial |
...
- 1539002 瑞典 vs 突尼斯 5-1：exact_score_log_loss=5.6316
- 1489370 美国 vs 巴拉圭 4-1：exact_score_log_loss=4.3863
- 1489374 德国 vs 库拉索 7-1：exact_score_log_loss=4.2371

### best_3_by_actual_score_probability

- 1489369 墨西哥 vs 南非 2-0：actual_score_probability=0.1587
- 1489375 科特迪瓦 vs 厄瓜多尔 1-0：actual_score_probability=0.1198
