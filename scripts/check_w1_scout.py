...
def main() -> int:
    ...
    for token in ("--fixture-id", "scout_file_exists", "cover_probability_model", "pass_reason", "dashboard_left_status_label", "dashboard_card_title", "dashboard_pass_reason_source", "dashboard_contains_forbidden_recommend_words", "PASS_ROOT_CAUSE_AUDIT", "audit.stale_lock_override", "dashboard_score_path_settlement", "dashboard_suspicious_edge_flag"):
